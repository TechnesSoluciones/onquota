...
import { Calendar, TrendingUp, TrendingDown, DollarSign, Download, Loader2, AlertCircle, AlertTriangle } from 'lucide-react'
import {
  BarChart,
  Bar,
  LineChart,
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Comparación Mensual de Gastos</h1>
          <p className="text-muted-foreground">
            Analiza y compara los gastos entre diferentes períodos
          </p>
        </div>
        <Card className="p-6">
